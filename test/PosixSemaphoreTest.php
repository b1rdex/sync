...
class PosixSemaphoreTest extends AbstractSemaphoreTest
{
    ...
    public function testGetId(): void
    {
        ...
        $this->assertSame(self::class, $this->semaphore->getId());
    }
        ...
        $this->assertRunTimeGreaterThan(function () {
            Loop::defer(function () {
                Task::async(function () {
                    ...
                    $awaitable1 = Task::async([$used, 'acquire']);
                    $awaitable2 = Task::async([$this->semaphore, 'acquire']);

                    Loop::delay(500, function () use ($awaitable1) {
     ...
     * @depends testUse
     */
    public function testInFork(): void
    {
        $this->assertRunTimeGreaterThan(function () {
            Loop::defer(function () {
                Task::async(function () {
